    ...
    return (
        <div id='featured' className='py-10 px-10 overflow-hidden'>
            ...
            <ul className='flex px-10 gap-5 justify-center'>
                <motion.li initial={{right:"400px", opacity:0}} whileInView={{right:0, opacity:1}} transition={{duration:0.7}} className='relative w-1/3'>
                    <img className='h-130 w-full' src={messi} alt="" />
                    <p className='text-xl mt-5'>"You have to fight to reach your dream." – Messi</p>
                </motion.li>
                <motion.li initial={{top:"300px",opacity:0}} whileInView={{top:0, opacity:1}} transition={{duration:0.7}} className='relative w-1/3'>
                    <img className='h-130 w-full' src={ronaldo} alt="" />
                   <p className='text-xl mt-5'>"Talent without working hard is nothing." – Ronaldo</p>
                </motion.li>
                <motion.li initial={{left:"400px",opacity:0}} whileInView={{left:0, opacity:1}} transition={{duration:0.7}} className='relative w-1/3'>
